    ...
    <>
      <div className="p-4 h-full md:pl-[300px]">
        ...
        <div className="flex gap-[10px] mb-3">
            ...
            <br />
            <button onClick={handleRegister} className={`font-bold w-full py-4 ${username !== "" || email !== "" || sucursal !== "Seleccionar Sucursal" || rol !== "Seleccionar Rol" || email.includes(dominiosPermitidos) || password !== "" || confirmPassword !== "" ? 'bg-[#ffa600] text-white' : 'bg-gray-500 text-[#707070] pointer-events-none'} text-[20px] rounded-[10px] transition-all ease-in-out duration-200`}>Registrar</button>
